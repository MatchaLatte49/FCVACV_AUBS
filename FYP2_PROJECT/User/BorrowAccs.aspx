<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="BorrowAccs.aspx.cs" Inherits="FYP2_PROJECT.User.BorrowAccs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container text-center">
                ...
                <div class="card border border-dark shadow p-1 mb-5 bg-white rounded">
                  <div class="card-body">
                      <h5 class="card-title text-dark">Accessories Extension/Hdmi</h5>
                      <p>LCD</p>
                     
                      <asp:Label ID="Label1" runat="server" Text="Choose Accs" Font-Bold="true"></asp:Label>
                      <br />
                      <asp:DropDownList ID="itemlist" CssClass="custom-select w-25 p-1" runat="server">
                      </asp:DropDownList>
