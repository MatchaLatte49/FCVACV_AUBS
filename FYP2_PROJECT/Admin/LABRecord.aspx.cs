...
{
    public partial class LABRecord : System.Web.UI.Page
    {
        ...
        protected void GVBind()
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("SELECT * FROM RequestsLAB WHERE Status = 'RECORDED'", con);
        ...
        protected void ExportToPDF_Click(object sender, EventArgs e)
        {
            ...
            Paragraph title = new Paragraph("Used LAB Record ");
            ...
            Response.AddHeader("content-disposition", "attachment;filename=LABRecord.pdf");
