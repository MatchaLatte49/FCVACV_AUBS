...
{
    public partial class BKkeys : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE BKTable SET keyName='" + name + "', status='" + status + "' where KID='" + id + "'", con);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("DELETE FROM BKTable where KID='" + ID + "'", con);
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string insertSql = "INSERT INTO BKTable (keyName) VALUES (@Name)";
