<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AccsRecord.aspx.cs" Inherits="FYP2_PROJECT.Admin.AccsRecord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" CssClass="table table-bordered border-dark" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#212529" HeaderStyle-ForeColor="#FFFFFF" OnRowDataBound="GridView1_RowDataBound" >
        <Columns>
            ...
            <asp:BoundField DataField="AccsName" HeaderText="type" />
