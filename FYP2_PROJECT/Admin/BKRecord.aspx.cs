...
{
    public partial class BKRecord : System.Web.UI.Page
    {
        ...
        protected void GVBind()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("SELECT * FROM RequestsBK WHERE Status = 'RECORDED'", con);
        ...
        protected void ExportToPDF_Click(object sender, EventArgs e)
        {
            ...
            Paragraph title = new Paragraph("Used BK Record ");
            ...
            Response.AddHeader("content-disposition", "attachment;filename=BKRecord.pdf");
