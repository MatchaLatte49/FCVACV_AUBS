...
{
    public partial class LCD : System.Web.UI.Page
    {
        ...
        protected void GVbind()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM LCDTable", con);
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE LCDTable SET LCDname='" + name + "', status='" + status + "' where LCDID='" + id + "'", con);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("DELETE FROM LCDTable where LCDID='" + ID + "'", con);
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string insertSql = "INSERT INTO LCDTable (LCDname) VALUES (@Name)";
                ...
                using (SqlCommand command = new SqlCommand(insertSql, con))
                {
                    ...
                    con.Close();
                    Response.Write("<script>alert('New LCD Successful Added');</script>");
                    GVbind();
